...
/**
 * Test for the Greater node using mockito, using @Mock and @Before annotations.
 *
 * @author Ensimag
 * @date 01/01/2026
 */
...
/*         assertTrue(t.getRightOperand() instanceof ConvFloat);
    ...
    public void testIntBoolean() throws ContextualError {
        Greater t = new Greater(intexpr1, booleanexpr1);
        // check the result
    ...
    //ajout
    @Test
    public void testPlusIntBoolean_Error() throws ContextualError {
        ...
        Plus t = new Plus(intexpr1, booleanexpr1);
    ...
    //ajout
    @Test
    public void testGreaterBooleanBoolean_Error() throws ContextualError {
        when(booleanexpr1.verifyExpr(compiler, null, null))
            .thenReturn(compiler.environmentType.BOOLEAN);
        when(booleanexpr2.verifyExpr(compiler, null, null))
            .thenReturn(compiler.environmentType.BOOLEAN);

        Greater t = new Greater(booleanexpr1, booleanexpr2);
