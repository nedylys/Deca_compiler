...
public abstract class AbstractIdentifier extends AbstractLValue {
    ...
    /* This Method is the translation of : identifier ↓env_exp ↑def which synthesizes def by inheriting env_exp */
    public abstract Definition verifyIdent(EnvironmentExp localEnv) throws ContextualError;
}
